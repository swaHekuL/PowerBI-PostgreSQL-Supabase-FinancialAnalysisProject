...
# --- CONFIG ---
# Uses the yfinance package to pull stock data for all S&P 500 companies.
# Companies are listed in the following list.
...
# --- GET DATA ---
# days_to_pull = 2 # originally pulled only 2 days of data for testing, switched to 3 months
# end_date = date.today()
...
# --- TRANSFORM ---
# transforms pandas dataframe to be cleaner and prepare for SQL injection
records = []
...
# sets up connection with Supabase using psycopg2 package
...
# injects into Supabase SQL database
for row in data:
    cur.execute("""
        INSERT INTO stg_stock_prices
        (symbol, date, open, high, low, close, volume, load_timestamp)
